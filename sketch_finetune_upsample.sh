task=$1
export LOGDIR=coco-edge/coco-upsample_${task}/ 
...
WEIGHT_FLAGS="--model_path pretrained/upsample_edge_decoder.pt --encoder_path/pretrained/upsample_edge_encoder.pt"
